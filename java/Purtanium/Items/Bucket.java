...
public class Bucket extends Item 
{
	...
	public Bucket(Block p_i45331_1_) 
	{
		this.maxStackSize = 1;
            ...
            if (movingobjectposition.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK)
            {
                ...
                if (flag)
                {
                    ...
                    if (material == Material.water && l == 0)
                    {
                        ...
                        return this.func_150910_a(p_77659_1_, p_77659_3_, PurtaniumItems.BucketWater);
                    }

                    if (material == Material.lava && l == 0)
                    {
                        p_77659_2_.setBlockToAir(i, j, k);
                        return this.func_150910_a(p_77659_1_, p_77659_3_, PurtaniumItems.BucketLava);
                    }
                }
                else
                {
                    ...
                    {
                        return new ItemStack(PurtaniumItems.Bucket);
                    }
